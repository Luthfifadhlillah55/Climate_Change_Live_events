...
app.layout = html.Div(children=[
    ...
    [
        ...
        dcc.Markdown('Created by [Luthfi Fadhlillah](https://www.linkedin.com/in/luthfi-fadhlillah-003363128/)'),
        dcc.Markdown('Find out more about the data, get the code, or help improve this figure on [GitHub](https://github.com/Luthfifadhlillah55)')
],
className='container'
    ...
    annotation = [
            {
                ...
                "xanchor": "right",
                "yref": "paper",
                "text": "Created by Luthfi Fadhlillah<br>Make your own at Climate-prediction.herokuapp.com",
                "y": 0.115,
                "x": 1,
                'align': 'right',
                # "ay": -40,
